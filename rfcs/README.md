...
| [RFC-0006](RFC-0006-FITPAC-prose-compiler-extension.md) | `fitpac.prose_compiler` extension | **Proposed** | Namespaced additive pack (shipped in reference distribution): prose→clause→obligation→graph pipeline, JSON Schemas, inventories, `fitpac.prose_compiler.p1`–`p6`. |
